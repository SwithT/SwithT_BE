...
public class BoardController {
    ...
    public ResponseEntity<SuccessResponse> createBoard(@PathVariable Long lectureGroupId, @RequestBody BoardCreateRequest boardCreateRequest) {
    ...
    public ResponseEntity<SuccessResponse> boardList(@PathVariable Long lectureGroupId,@PageableDefault(size = 5)Pageable pageable){
    ...
    public ResponseEntity<SuccessResponse> boardDetail(@PathVariable Long boardId){
    ...
    // Todo: 나의 게시글 목록 조회 -> security holder랑 security util 같은 거 되고 나면 구현


    // 게시글 update
    @PutMapping("/lecture/board/{boardId}")
    public ResponseEntity<SuccessResponse> updateBoard(@PathVariable Long boardId, @RequestBody BoardUpdateRequest boardUpdateRequest) {
