...
## 🎇 주요 기능
- 강의/과외 개설 : 강의/과외에 대한 기본 정보 입력 후 시간 및 장소에 따른 강의 그룹을 생성합니다. 

- 강의 신청 ( 대기열 및 결제 ) : 수강생이 신청 시 남은 인원에 따라 대기열을 거친 후 신청 및 결제가 됩니다. 신청할 수 있는 인원이 0명이면 신청되지 않습니다.

- 과외 신청 및 승인 및 결제 : 수강생이 과외 신청 시 강사에게 알림이 가며, 강사의 승인 시 수강생에게 결제 알림이 가고 결제 완료 시 신청이 완료됩니다.

- 강사와 수강생간 채팅 : 강사 및 수강생 간 채팅을 통하여 대화를 나눕니다.

- 강의/과외 커뮤니티 : 게시글 및 공지사항, 댓글, 과제 등의 강사와 수강생 간 커뮤니티 공간을 제공합니다.

- 일정 캘린더 : 수업 일자 및 과제 일자 등 강의/과외 관련한 일정이 자동으로 설정되며, 개인 일정도 등록할 수 있습니다. 

- 알림 : 결제 알림이나 강의 신청 알림 및 채팅 알림 등 강의/과외 관리에 필요한 알림을 제공합니다.
  <br/>
